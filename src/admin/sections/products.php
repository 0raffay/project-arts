                ...
                <div class="row all-product-container py-3">
                    <?php foreach (Product::$instances as $product) { ?>
                        <div class="all-product-item col-lg-6 col-md-6 col-sm-12  d-flex align-items-center ">
                            ...
                            <div class="col-lg-3">
                                <a class="addHover mx-auto d-block" href="?openProductModal&productId=<?php echo "$product->SKU" ?>">Edit</a>
                            </div>
                        </div>
                    <?php } ?>
                </div>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php  print_r($productId);?>
                    <form method="post" enctype="multipart/form-data">
                        <div class="row py-4">
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="input__wrap">
                                    <label for="">Product Title</label>
                                    <input value="<?php echo $thisProduct->name;?>" class="border py-2 px-2 w-100 d-block" required type="text" >
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="input__wrap">
                                    <label for="">Price</label>
                                    <input value="<?php echo $thisProduct->price;?>" class="border py-2 px-2 w-100 d-block" required type="text" >
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="input__wrap">
                                    <label for="">Brand / Store</label>
                                    <input value="<?php echo $thisProduct->brand;?>" class="border py-2 px-2 w-100 d-block" required type="text" >
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="input__wrap">
                                    <label for="">Product Category</label>
                                    <select class="border py-2 px-2 w-100 d-block" required  id="">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="input__wrap">
                                    <label for="">Units Available</label>
                                    <input value="<?php echo $thisProduct->stock;?>" class="border py-2 px-2 w-100 d-block" required >
                                </div>
                            </div>
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="input__wrap">
                                    <label for="">Description</label>
                                    <textarea  class="border px-2 py-2 w-100 d-block"  id="" cols="30" rows="10">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="input__wrap">
                                    <label for="">Add Search Keywords</label>
                                    <input value="<?php echo $thisProduct->keywords;?>" class="border py-2 px-2 w-100 d-block" required >
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="input__wrap">
                                    <label for="">Edit Warranty</label>
                                    <input value="<?php echo $thisProduct->warranty;?>" class="border py-2 px-2 w-100 d-block" required >
                                </div>
                            </div>
                        </div>
                    </form>
                ...
                <div class="modal-footer d-flex justify-content-between" style="min-height: 70px">
                     <button type="button" class="btn btn-secondary hidden updateProductButton" data-id="<?php echo $thisproduct->SKU;?>" data-dismiss="modal">Update Product</button>
                </div>
            </div>
        </div>
    </div>
