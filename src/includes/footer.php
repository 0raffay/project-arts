            ...
            <div class="col-lg-6 col-sm-12">
                <div class="row">
                    <div class="col-lg-6 col-sm-12">
                        ...
                        <ul>
                            <li><a href="<?php echo $site__phone; ?>">Call Us: <?php echo $site__phone; ?></a></li>
                            <li><a href="">Mon-Fri: 9:00 AM - 6:00 PM</a></li>
                            <li><a href="<?php echo $site__email; ?>">Send us an email</a></li>
                        </ul>
                    </div>
                    <div class="col-lg-6 col-sm-12">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-12 col-sm-12">
                        <div class="d-flex gap-10">
                            <img src="assets/images/payments/icons.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
